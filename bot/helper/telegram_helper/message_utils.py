...
from bot import AUTO_DELETE_MESSAGE_DURATION, LOGGER, bot, \
    status_reply_dict, status_reply_dict_lock, download_dict, download_dict_lock, botStartTime, Interval, DOWNLOAD_STATUS_UPDATE_INTERVAL, dispatcher, OWNER_ID, LOG_UNAME, LOG_CHANNEL
from bot.helper.ext_utils.bot_utils import get_readable_message, get_readable_file_size, get_readable_time, MirrorStatus, setInterval, progress_bar
...
def update_all_messages():
    ...
    msg += f"\n\n<b>BOT UPTIME :</b> <b>{currentTime}</b>\n\n"
    with download_dict_lock:
        ...
        msg += f"<b>DL :</b> <b>{dlspeed}ps</b>\n<b>UL :</b> <b>{ulspeed}ps</b>\n"
    with status_reply_dict_lock:
...
def sendStatusMessage(msg, bot):
    ...
    progress += f"<b>BOT UPTIME :</b> <b>{currentTime}</b>\n\n"
    with download_dict_lock:
        dlspeed_bytes = 0
        uldl_bytes = 0
        for download in list(download_dict.values()):
