...
class _BotCommands:
    def __init__(self):
        ...
        self.TarMirrorCommand = getCommand('TARMIR_BOT', f'tarmir{BOT_NO}')
        self.ZipMirrorCommand = getCommand('ZIP_BOT', f'zipmir{BOT_NO}')
        self.CancelMirror = getCommand('CANCEL_BOT', f'cancel{BOT_NO}')
        self.CancelAllCommand = getCommand('CANCEL_ALL_BOT', f'cancelall{BOT_NO}')
        ...
        self.RestartCommand = getCommand('RESTART_BOT', f'restart{BOT_NO}')
        ...
        self.TarWatchCommand = getCommand('TARYTDL_BOT', f'taryt{BOT_NO}')
        ...
        self.QbTarLeechCommand = getCommand('QBITTAR_LEECH', f'qbtarleech{BOT_NO}')
        ...
        self.LeechTarWatchCommand = getCommand('WATCHTAR_LEECH', f'leechtarwatch{BOT_NO}')
