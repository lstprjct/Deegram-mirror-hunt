...
def mirror(update, context):
    _mirror(context.bot, update, update.message)

def unzip_mirror(update, context):
    _mirror(context.bot, update, update.message, extract=True)

def zip_mirror(update, context):
    _mirror(context.bot, update, update.message, True)

def qb_mirror(update, context):
    _mirror(context.bot, update, update.message, isQbit=True)

def qb_unzip_mirror(update, context):
    _mirror(context.bot, update, update.message, extract=True, isQbit=True)

def qb_zip_mirror(update, context):
    _mirror(context.bot, update, update.message, True, isQbit=True)

def leech(update, context):
    _mirror(context.bot, update, update.message, isLeech=True)

def unzip_leech(update, context):
    _mirror(context.bot, update, update.message, extract=True, isLeech=True)

def zip_leech(update, context):
    _mirror(context.bot, update, update.message, True, isLeech=True)

def qb_leech(update, context):
    _mirror(context.bot, update, update.message, isQbit=True, isLeech=True)

def qb_unzip_leech(update, context):
    _mirror(context.bot, update, update.message, extract=True, isQbit=True, isLeech=True)

def qb_zip_leech(update, context):
    _mirror(context.bot, update, update.message, True, isQbit=True, isLeech=True)
